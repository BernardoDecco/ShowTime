package com.showtime.robot.trading.app;
...
import com.showtime.robot.trading.backtest.BacktestEngine;
import com.showtime.robot.trading.backtest.BacktestResult;
import com.showtime.robot.trading.strategies.DailySmaCrossStrategy;
import java.math.BigDecimal;

/**
 * Command line entrypoint that runs a backtest for a single symbol over a given history range using
 * the {@link DailySmaCrossStrategy} and prints a short performance summary.
 */
