 ...
 *
 * <p>Implementations receive a multi-timeframe market snapshot and the current account context, and
 * must return a {@link StrategyDecision} describing what to do at this step.
 */
