package com.horadoshow.robot.marketdata.brapi;
...
import com.horadoshow.robot.marketdata.brapi.dto.BrapiQuoteResponse;
import com.horadoshow.robot.marketdata.brapi.dto.BrapiQuoteResult;
import com.horadoshow.robot.marketdata.brapi.dto.BrapiQuoteResultHistorical;
...
public final class BrapiMarketDataClient implements MarketDataClient {
  ...
  public BrapiMarketDataClient(HttpClient http, ObjectMapper mapper, String baseUrl, Optional<String> token) {
  ...
  public List<Candle> getDailyCandles(String symbol, MarketDataRange range) {
    ...
    return r.historicalDataPrice().stream()
        .filter(h -> h.date() != null && h.open() != null && h.high() != null && h.low() != null && h.close() != null)
  ...
  private static Candle toCandle(BrapiQuoteResultHistorical h) {
    ...
    return new Candle(
        ...
        h.adjustedClose() == null ? BigDecimal.valueOf(h.close()) : BigDecimal.valueOf(h.adjustedClose())
    );
  }
